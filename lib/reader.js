...
function workFiles (fn, filenames) {
...
Reader.prototype.readFileGlob = function (globpath) {
	...
	.then(function (filenames) {
		return workFiles.call(self, self.readFile.bind(self), filenames);
	})
};
...
Reader.prototype.readFiles = function (filenames) {
	...
	return workFiles.call(this, this.readFileGlob.bind(this), filenames);
};
